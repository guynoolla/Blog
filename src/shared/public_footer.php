...
<footer class="<?php echo $bg ?>" role="contentinfo" id="scrollFooter">
	<div class="footer-content">
		...
		<div class="copyright mt-4"><?php echo trim($jsonstore->copyright) ?></div>
	</div>
	<a href="#page" class="scroll-to-top" id="scrollToTopJS" style="display:block;width:2.5rem;height:2.5rem;">
